...
你覺得張大智是單純的自殺，還是被人殺害的？` },
      { type:"answer",
        fields:{
          e1:{ kind:"select", options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東新的證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄"], accept:"林孟君聊天紀錄" },
...
你知道凶手是誰了嗎？` },
      { type:"answer",
        fields:{
          ...
          f2:{ kind:"select", options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東新的證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄"], accept:"何文禮聊天紀錄" },
          f3:{ kind:"select", options:["金錢","理想","感情","復仇","意外"], accept:"金錢" }
        },
        rows:[
          { parts:["凶手很可能是 ",{field:"f1"},"，從 ",{field:"f2"}," 可以得知，他的犯案動機應該是 ",{field:"f3"},"。"] }
        ]
      },
      { type:"narrative", text:
...
就請你告訴我，我究竟漏掉了什麼？` },
      { type:"answer",
        fields:{
          gA:{ kind:"select", options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單"], accept:[] },
          gB:{ kind:"select", options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單"], accept:[] },
...
在「哈卡克心理測驗」裡，到底還藏了什麼秘密？` },
      { type:"answer",
        fields:{
          h1:{ kind:"select",
               options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單","許蕙萍自白","許蕙欣遺書","五年前的報紙"],
               accept:"心理測驗原稿" },
          h2:{ kind:"select",
               options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","廖雅之回饋單","莊曉純回饋單","何文禮回饋單","陳信榮回饋單","陳齊賢回饋單","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單","許蕙萍自白","許蕙欣遺書","五年前的報紙"],
               accept:"社團廣告單" },
