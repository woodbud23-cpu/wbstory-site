...
那告訴我吧，張大智留下的死亡訊息，究竟是什麼意思？` },
      { type:"answer",
        ...
        rows:[
          { parts:["張大智手上的死亡訊息，其實是一個 ",{field:"t1"},"，意思是 ",{field:"t2"},"。"] }
      ]},
      { type:"narrative", text:
`哈卡克？
我好像在哪裡聽過這個詞彙。` },
...
就請你告訴我，我究竟漏掉了什麼？` },
      { type:"answer",
        fields:{
          ...
          gD:{ kind:"text",  accept:["老婆","伴侶","太太","夫人","配偶"] }
        },
        rows:[
...
在「哈卡克心理測驗」裡，到底還藏了什麼秘密？` },
      { type:"answer",
        fields:{
          h1:{ kind:"select",
               options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","回饋單1","回饋單2","回饋單3","回饋單4","回饋單5","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單","許蕙萍自白","許蕙欣遺書"],
               accept:"心理測驗原稿" },
          h2:{ kind:"select",
               options:["心理測驗","心理測驗結果","何文禮的證詞","郭榮泰的證詞","莊曉純的證詞","林孟君的證詞","黃素娥的證詞","案發現場照片","桌面照片","死者手部照片","死者和前女友的合照","現場報告","解剖紀錄","報紙","鈔票照片","發票照片","手機支架照片","房東的新證詞","死者銀行紀錄","心理測驗原稿","回饋單1","回饋單2","回饋單3","回饋單4","回饋單5","林孟君聊天紀錄","何文禮聊天紀錄","郭榮泰聊天紀錄","莊曉純聊天紀錄","何文禮的新證詞","社團廣告單","許蕙萍自白","許蕙欣遺書"],
               accept:"社團廣告單" },
